//Funções mais genéricas estão dentro desse arquivo 
...
function ordenarPorAtribNumerico(attr, ordem = 'asc'){
    return function(array){
        const asc = (o2, o1) => o1[attr] - o2[attr]
...
//module exports - criando um atributo ler diretório para tornar visivel a funcao
